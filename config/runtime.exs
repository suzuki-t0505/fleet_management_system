...
#
#     PHX_SERVER=true bin/core_app start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :core_app, CoreAppWeb.Endpoint, server: true
end
  ...
  config :core_app, CoreAppWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/core_app_web/router\.ex$"E,
        ~r"lib/core_app_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :core_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :core_app, CoreApp.Mailer,
