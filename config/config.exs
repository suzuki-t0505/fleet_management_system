...
config :core_app, CoreAppWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CoreAppWeb.ErrorHTML, json: CoreAppWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: CoreApp.PubSub,
  live_view: [signing_salt: "He6MwjFv"]
...
config :core_app, CoreApp.Mailer, adapter: Swoosh.Adapters.Local
